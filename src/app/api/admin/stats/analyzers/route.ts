...
export async function GET() {
  try {
    const response = await fetch(`${BACKEND_URL}/admin/stats/analyzers`, {
      method: 'GET',
      headers: {
    ...
    console.error('Error fetching analyzer statistics:', error);
    return NextResponse.json(
      { 
        success: false,
        error: 'Failed to fetch analyzer statistics', 
